...
import { removeChatRoom, setChatRooms, setMessageRecevied, setSocket } from "../redux/actions/chatActions";
...
const HeaderComponent = () => {
  ...
  useEffect(() => {
    if (userInfo.isAdmin) {
      ...
      socket.on("server sends message from client to admin", ({ user, message }) => {
        ...
        dispatch(setMessageRecevied(true))
        audio.play()
      })
  ...
  return (
    <Navbar collapseOnSelect expand="lg" bg="dark" variant="dark">
      <Container>
        <LinkContainer to="/">
          <Navbar.Brand href="/">venky ONLINE SHOP</Navbar.Brand>
        </LinkContainer>
