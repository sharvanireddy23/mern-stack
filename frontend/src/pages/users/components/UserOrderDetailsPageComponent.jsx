...
const UserOrderDetailsPageComponent = ({ userInfo, getUser, getOrder, loadPayPalScript }) => {
    ...
    const [orderButtonMessage, setOrderButtonMessage] = useState("place your order");
                ...
                <Col md={8}>
                    ...
                    <ListGroup variant='flush'>
                        {cartItems.map((item, index) => (
                            <CartItemComponent item={item} key={index} orderCreated={true} />
                        ))}
                    </ListGroup>
                </Col>
                <Col md={4}>
                    <ListGroup>
                        ...
                        <ListGroup.Item>
                            <div className='d-grid gap-2'>
                                <Button variant='danger' onClick={orderHandler} size='lg' type='button' disabled={buttonDisabled}>
                                    {orderButtonMessage}
                                </Button>
                            </div>
